const Card = ({ saldoSPP, saldoZakat }) => {
  return (
    <div className="flex flex-col md:flex-row gap-4">
      <div className="bg-emerald-800 text-white p-6 w-full rounded-2xl shadow-md border border-emerald-700 flex flex-col justify-between">
        <div>
        ...
        <div className="mt-4 bg-black/20 p-3 rounded-lg text-xs font-medium space-y-1">
      ...
      {/* KARTU KAS SPP */}
      <div className="bg-blue-800 text-white p-6 w-full rounded-2xl shadow-md border border-blue-700 flex flex-col justify-between">
        <div>
          <p className="text-white text-sm font-medium mb-1">
